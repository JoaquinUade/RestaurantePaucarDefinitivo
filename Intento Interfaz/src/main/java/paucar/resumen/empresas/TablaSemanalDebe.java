...
public class TablaSemanalDebe {
    ...
    private final VentasBackend backend;/*
                                         * declara un campo backend que es una instancia de VentasBackend,
                                         * se usará para cargar las ventas del día y filtrar las deudas de
                                         * empresas
                                         */

    private final TableView<Map<String, Object>> tabla;/*
                                                        * crea una tabla para mostrar las deudas semanales
                                                        * de empresas
                                                        */

    private static final Locale LOCALE_AR = Locale.of("es", "AR");/*
                                                                   * Define un locale específico para español de
                                                                   * Argentina
                                                                   */

    private static final DateTimeFormatter FECHA_FORMATO = DateTimeFormatter.ofPattern("d MMMM yyyy", LOCALE_AR);/*
                                                                                                                  * Define
                                                                                                                  * un
                                                                                                                  * formato
                                                                                                                  * de
    ...
    private void definirColumnas() {
        ...
        TableColumn<Map<String, Object>, String> colFecha = new TableColumn<>("Fecha");/*
                                                                                        ...
                                                                                        * “Fecha”
                                                                                        * para una TableView donde cada
                                                                                        * fila
                                                                                        * es un Map<String, Object> y
                                                                                        * cada
                                                                                        * celda muestra un String y la
                                                                                        * guarda
        ...
        colFecha.setCellValueFactory(fila -> {/* por cada fila de colFecha, haremos lo siguiente */
            ...
            LocalDate fecha = (LocalDate) fila.getValue().get("fecha");/*
                                                                        * Obtiene la fecha de la fila
                                                                        * actual
                                                                        */

            return new SimpleObjectProperty<>(fecha == null ? "" : fecha.format(FECHA_FORMATO));/*
                                                                                                 * devuelve la fecha, si
                                                                                                 * la fecha es null se
                                                                                                 * deja vacía sino
                                                                                                 * muestra formateada la
                                                                                                 * fecha
                                                                                                 */
        });
        ...
        TableColumn<Map<String, Object>, String> colDescripcion = crearColumnaTexto("Descripción", "descripcion",
                13);/*
                     * Crea una columna llamada colDescripcion usando un método que arma columnas
        ...
        colMonto.setCellValueFactory(fila -> {/*
                                               * por cada fila de la columna se hace el siguiente
                                               * bloque de codigo
                                               */
            ...
            return new SimpleObjectProperty<>(MONEDA.format(m == null ? 0 : m.doubleValue()));/*
                                                                                               * si el monto es null
                                                                                               * muestra
                                                                                               * cero, sino muestra el
                                                                                               * monto
                                                                                               * formateado a moneda
                                                                                               */
        });

        TableColumn<Map<String, Object>, String> colTipo = new TableColumn<>("Tipo de pago");/*
                                                                                              * Crea una columna llamada
                                                                                              * colTipo
                                                                                              */
        ...
        tabla.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY_FLEX_LAST_COLUMN);/*
                                                                                           * Le indica a la tabla que
                                                                                           * las
                                                                                           * columnas se ajusten
                                                                                           * automáticamente
                                                                                           * al ancho disponible, y que
                                                                                           * la
                                                                                           * última columna sea la más
                                                                                           * flexible
                                                                                           */
    }
    ...
    private TableColumn<Map<String, Object>, String> crearColumnaTexto(
        ...
        TableColumn<Map<String, Object>, String> col = new TableColumn<>(titulo);/*
                                                                                  * Crea una nueva columna de una tabla,
                                                                                  * la guarda en la variable col y le
                                                                                  * pone como título el texto recibido
                                                                                  * en
                                                                                  * titulo
                                                                                  */

        col.setCellValueFactory(fila -> new SimpleObjectProperty<>((String) fila.getValue().get(key)));/*
                                                                                                         por cada fila
                                                                                                         de la columna,
                                                                                                         obtiene el
                                                                                                         valor asociado
        ...
        col.setCellFactory(columna -> new TableCell<>() {/*
                                                          * Para cada celda de esta columna, usá este tipo de
                                                          * celda personalizada
                                                          */
            ...
            private final Text text = new Text();/* crea un nodo de texto para mostrar el contenido de la celda */
            {
                text.wrappingWidthProperty().bind(columna.widthProperty().subtract(padding));/*
                                                                                              * Hace que el texto en la
                                                                                              * celda se ajuste al ancho
                                                                                              * de la columna, dejando
                                                                                              * un margen (padding) y
                                                                                              * ajustándose cuando la
                                                                                              * columna cambia de tamaño
                                                                                              */

                setGraphic(text);/* Usa el objeto Text como contenido visual de la celda */
                setPrefHeight(Region.USE_COMPUTED_SIZE);/*
                                                         * Permite que la altura de la celda se ajuste
            ...
            protected void updateItem(String item, boolean empty) {
                super.updateItem(item, empty);/*
                                               * Cada vez que se actualiza el contenido de la celda, se
                                               * ejecuta este método
                                               */

                if (empty || item == null || item.isBlank()) {/*
                                                               * si la celda esta vacia o es null o esta
                                                               * en blanco
                                                               */
                    ...
                    setTooltip(new Tooltip(item));/*
                                                   * Establece el tooltip de la celda como el valor
                                                   * recibido
                                                   */
                }
            }
