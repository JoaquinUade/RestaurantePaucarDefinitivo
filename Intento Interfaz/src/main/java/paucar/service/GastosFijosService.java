...
public class GastosFijosService {
    ...
    // ✅ OBTENER TODOS
    public List<GastosFijos> obtenerTodos() {
        try {
            ...
            if (response.statusCode() >= 200 && response.statusCode() < 300) {
                return mapper.readValue(
                        ...
                        mapper.getTypeFactory()
                                .constructCollectionType(List.class, GastosFijos.class));
            }
    ...
    // ✅ CREAR
    public void crear(GastoFijoRequest gasto) {
        try {
...
// ✅ EDITAR
public void editar(Long id, GastoFijoRequest gasto) {
    try {
        String json = mapper.writeValueAsString(gasto);
